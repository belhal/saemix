...
###RTTE
timetoevent.saemix <- read.table("data/weibull_data.csv", header=T, sep=",")
...
#Warfarin
options_warfa<-list(seed=39546,map=F,fim=F,ll.is=T,nbiter.mcmc = c(2,2,2), nbiter.saemix = c(K1,K2),nbiter.sa=0,displayProgress=TRUE,nbiter.burn =0)
